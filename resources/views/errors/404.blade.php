...
<head>
    ...
    <meta name="description" content="Запрошенная страница не найдена или никогда не существовала. Попробуйте обновить страницу или изменитть запрос.">
    ...
    <main>
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 align-self-center">
              <h1>Ошибка 404</h1>
              <h2>Похоже, что мы потерялись</h2>
              <p>
                Запрашиваемая страница не найдена или никогда не существовала, попробуйте изменить запрос и попробовать снова
              </p>
              <a href="{{url()->previous()}}" class="btn btn-primary back-btn">Вернуться назад</a>
            </div>
          </div>
        </div>
      </main>
